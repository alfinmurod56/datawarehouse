        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePegawai" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="barchartship.php">Grafik Metode</a>
                                    <a class="nav-link" href="data_ship.php">Data Metode</a>
                                </nav>
                            </div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
          $sql = 'SELECT    fp.pembelianID, fp.realStoked, pr.namaProduk as namaproduk, vn.namaVendor as namavendor, s.nameShip as shipmethod, d.tanggalLengkap
          from fact_purchase fp
          join product pr on fp.ProductID = fp.ProductID
          join vendor vn on fp.VendorID = vn.vendorID
          join shipmethod s on fp.shipMethodID = s.shipMethodID
          join dim_date d on fp.dateID = d.dateID
          ...
          while ($row = mysqli_fetch_array($query)) {
            echo '<tr>
		    	...
		    	<td>' . $row['realStoked'] . '</td>
		    	<td>' . $row['namaproduk'] . '</td>
		    	<td>' . $row['namavendor'] . '</td>
		    	<td>' . $row['shipmethod'] . '</td>
		    	<td>' . $row['tanggalLengkap'] . '</td>
		      </tr>';
          }
          echo '
          </tbody>
