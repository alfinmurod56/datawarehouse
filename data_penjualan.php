                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
          $sql = 'select p.salesOrderID, c.customerName, pr.namaProduk, p.salesQty, d.tanggalLengkap, fs.subtotal
          from penjualan p 
          join fact_subtotal fs  on fs.salesOrderID = p.salesOrderID
          join customer c  on fs.customerID = c.customerID 
          join product pr on fs.ProductID = pr.ProductID 
